...
if __name__ == '__main__':
    ...
    if args.parallel>0 and ENABLE_PAR:
        results = Parallel(n_jobs=args.parallel, verbose=2)(delayed(compile_result)(x, clf, cod_align, model) for x in reafinder.run_analysis(codon_align, fcodon_align))
        done = True
    ...
    if args.expos and results:
        ...
        exp_outfile = outfile=os.path.join(reafinder.settings.OUTDIR, "positions.json" )
