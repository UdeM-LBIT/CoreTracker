...
#
#
# This file part of the Environment for Tree Exploration program
...
class WebTreeApplication(object):
    """ Provides a basic WSGI application object which can handle ETE
        ...
        The basic WSGI is extended here to run CoreTracker
    """
    ...
    def __init__(self, application=None):
        ...
        self._treeid2layout = {}
        self._external_app_handler = application
        self._treeid2tree = {}
        self._treeid2cache = {}
        self._treeid2index = {}
        self.queries = {}
    ...
    def __call__(self, environ, start_response):
        ...
        try : 
            ...
            method = path[1]
            if method in ['draw', 'get_menu', 'action']:
                ...
                appiter =  self._external_app_handler(environ, start_response)
                return appiter
